...
with tab1:
    ...
    # =============================
    st.subheader("Grafik Rata-rata TML (Tinggi Muka Laut) dari Koordinat Tertentu")
...
with tab2:
    ...
    fig_trend.update_layout(
        title='Tren Tinggi Muka Laut (TML) Indonesia Periode 1993-2023',
        xaxis_title='Time',
        yaxis_title='TML (m)',
        width=900,
        height=500,
...
with tab3:
    ...
    fig_map_trend.update_layout(
        ...
        height=480,
        margin={"r":0, "t":100, "l":0, "b":0},
        title="Peta Tren Sea Surface Height (mm/tahun)"
    )
